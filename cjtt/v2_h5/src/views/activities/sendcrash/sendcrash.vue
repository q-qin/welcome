<template>
  <div class="wrapper" ref="wrapper">
    <!-- 全局header -->
    <nv-head ref="head" :show-head="false" :fix-head="false" page-name="现金大派送">
    </nv-head>
    ...
    <div v-show="!loading">
      <div class="main content">
        ...
        <div class="sendcrash_three">
          ...
          <div class="bhb" v-for="(item,$index) in dsapn" :key="'d'+$index">
      ...
      if (rs && rs.code === 1001 && rs.data) {
        ...
        this.config.list.forEach((n, i) => {
          if (i == 0) {
            ...
            if (this.status > 0) {
              this.posters[0].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[0].src = require("@/assets/images/activities/fx.png");
              ...
              this.posters[0].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[0].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 1) {
            this.posters.push({
            ...
            if (this.status > 1) {
              this.rposters[1].src = require("@/assets/images/activities/fx.png");
              this.posters[1].src = require("@/assets/images/activities/jihuo.png");
              ...
              this.posters[1].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[1].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 2) {
            this.posters.push({
            ...
            if (this.status > 2) {
              this.posters[2].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[2].src = require("@/assets/images/activities/fxdown.png");
              ...
              this.posters[2].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[2].src = require("@/assets/images/activities/nofxdown.png");
            }
          } else if (i == 3) {
            this.posters.push({
            ...
            this.rposters.push({
              style:
                "top:2.4rem;left:4.4rem;width: 0.7rem;transform:rotate(180deg)"
            });
            if (this.status > 3) {
              this.posters[3].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[3].src = require("@/assets/images/activities/fx.png");
              ...
              this.posters[3].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[3].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 4) {
            this.posters.push({
            ...
            this.rposters.push({
              style:
                "top:2.4rem;left:2.4rem;width: 0.7rem;transform:rotate(180deg)"
            });
            if (this.status > 4) {
              this.posters[4].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[4].src = require("@/assets/images/activities/fx.png");
              ...
              this.posters[4].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[4].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 5) {
            this.posters.push({
            ...
            if (this.status > 5) {
              this.rposters[5].src = require("@/assets/images/activities/fxdown.png");
              this.posters[5].src = require("@/assets/images/activities/jihuo.png");
              ...
              this.posters[5].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[5].src = require("@/assets/images/activities/nofxdown.png");
            }
          } else if (i == 6) {
            this.posters.push({
            ...
            if (this.status > 6) {
              this.rposters[6].src = require("@/assets/images/activities/fx.png");
              this.posters[6].src = require("@/assets/images/activities/jihuo.png");
              ...
              this.posters[6].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[6].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 7) {
            this.posters.push({
            ...
            if (this.status > 7) {
              this.rposters[7].src = require("@/assets/images/activities/fx.png");
              this.posters[7].src = require("@/assets/images/activities/jihuo.png");
              ...
              this.posters[7].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[7].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 8) {
            this.posters.push({
            ...
            if (this.status > 8) {
              this.posters[8].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[8].src = require("@/assets/images/activities/fxdown.png");
              ...
              this.posters[8].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[8].src = require("@/assets/images/activities/nofxdown.png");
            }
          } else if (i == 9) {
            this.posters.push({
            ...
            this.rposters.push({
              style:
                "top:6.4rem;left:4.4rem;width: 0.7rem;transform:rotate(180deg)"
            });
            if (this.status > 9) {
              this.posters[9].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[9].src = require("@/assets/images/activities/fx.png");
              ...
              this.posters[9].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[9].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 10) {
            this.posters.push({
            ...
            this.rposters.push({
              style:
                "top:6.4rem;left:2.4rem;width: 0.7rem;transform:rotate(180deg)"
            });
            if (this.status > 10) {
              this.posters[10].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[10].src = require("@/assets/images/activities/fx.png");
              ...
              this.posters[10].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[10].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 11) {
            this.posters.push({
            ...
            if (this.status > 11) {
              this.posters[11].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[11].src = require("@/assets/images/activities/fxdown.png");
              ...
              this.posters[11].src = require("@/assets/images/activities/nojihuo.png");
              this.rposters[11].src = require("@/assets/images/activities/nofxdown.png");
            }
          } else if (i == 12) {
            this.posters.push({
            ...
            if (this.status > 12) {
              this.posters[12].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[12].src = require("@/assets/images/activities/fx.png");
              ...
              this.posters[12].src = require("@/assets/images/activities/middlenoactive.png");
              this.rposters[12].src = require("@/assets/images/activities/nofx.png");
            }
          } else if (i == 13) {
            this.posters.push({
            ...
            if (this.status > 13) {
              this.posters[13].src = require("@/assets/images/activities/jihuo.png");
              this.rposters[13].src = require("@/assets/images/activities/fxdown.png");
              ...
              this.posters[13].src = require("@/assets/images/activities/middlenoactive.png");
              this.rposters[13].src = require("@/assets/images/activities/nofxdown.png");
            }
          } else if (i == 14) {
            this.posters.push({
            ...
            if (this.status > 14) {
              this.posters[14].src = require("@/assets/images/activities/jihuo.png");
              ...
              this.posters[14].src = require("@/assets/images/activities/big_icon.png");
            }
          }
        });
      } else {
...
.sendcrash_one {
  background: url("../../../assets/images/activities/sendcrash_bg.png");
  background-size: 100%;
  width: 100%;
  height: 6.44rem;
  position: relative;
...
.sendcrash_two {
  background: url("../../../assets/images/activities/sendcrash_xq.png");
  background-size: 100%;
...
.bagget {
  ...
  .sbagr {
    ...
    .ico {
      width: 3.19rem;
      height: 2.04rem;
      background: url(../../../assets/images/activities/tudi_bag_get_ico.png)
        no-repeat center center;
      background-size: 100%;
      margin: 0 auto;
    }
...
.onbagopend {
  ...
  .sbagr {
    ...
    .ico {
      width: 1.3rem;
      height: 1.54rem;
      background: url(../../../assets/images/activities/xqd.png) no-repeat
        center center;
      background-size: 100%;
      margin: 0 auto;
    }
  ...
  .sbagr {
    ...
    .sendcrash_all {
      ...
      .touico {
        width: 1.22rem;
        height: 0.53rem;
        background: url(../../../assets/images/activities/toubu_ico.png)
          no-repeat center center;
        background-size: 100%;
        margin: 0 auto;
        position: relative;
...
.dacheng {
  ...
  .bagrbg {
    ...
    right: 0;
    margin: -4.59rem auto;
    background: url(../../../assets/images/activities/gx.png) no-repeat center
      center;
    background-size: 100%;
    .bagrbg1 {
      position: absolute;
    ...
    .bagrbg3 {
      position: absolute;
      background: url(../../../assets/images/activities/gb.png) no-repeat center
        center;
      background-size: 100%;
      width: 0.72rem;
      height: 0.72rem;
