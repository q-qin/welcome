<template>
  <div>
    ...
    <!-- 全局header -->
    <nv-head ref="head" :show-head="false" :fix-head="false" page-name="任务中心">
    </nv-head>
    ...
    <div class="taskCenter" v-show="!loading">
      ...
      <div class="modal" v-show="treasureBoxModalShow" @touchmove.prevent>
        <div class="treasureBoxModal">
          ...
          <button class="share" @click="share">分享到朋友圈再赚30金币</button>
...
export default {
  ...
  methods: {
    ...
    async getNewerTasks() {
      ...
      let rs = await ajax(
        "post",
        this.$apiurl + "/tasks/get_newer_lists",
        comm,
        params
      );
    ...
    async getNewerStatus() {
      ...
      let rs = await ajax(
        "post",
        this.$apiurl + "/user_newer_activity/get_read_schedule",
        comm,
        params
      );
      if (rs && rs.code === 1001 && rs.data) {
    ...
    async getTasks() {
      ...
      let rs = await ajax(
        "post",
        this.$apiurl + "/tasks/get_tasks_lists",
        comm,
        params
      );
      if (rs && rs.code === 1001 && rs.data) {
        rs.data.forEach((n, i) => {
          ...
          if (n.task_keys == "wzyd_3" || n.task_keys == "yzpl") {
            ...
            n.task_keys == "share_article" ||
            n.task_keys == "share_article_read"
          ) {
            n.btn = "去分享";
          } else {
            n.btn = "去阅读";
    ...
    togglenewer(event, index) {
      if (
        this.newerTasks[index].task_keys == "ydzx_xinshou" &&
        !this.newerList.length
      ) {
        this.getNewerStatus();
      }
    ...
    newerToDo(event, item) {
      switch (item.task_keys) {
        case "ydzx_xinshou":
          appcall.navigator({
            title: "新手阅读任务",
            url: this.$h5url + "/activities/noviceAsk.html#/noviceReadTask"
          });
          break;
        default:
          appcall.articles();
    ...
    toDo(event, n) {
      if (n.task_keys == "wzyd_3") {
        ...
        appcall.navigator({
          title: "愚人节活动",
          url: this.$h5url + pagers[$this.currVer].aprilFoolsDay,
        });
      } else if (n.task_keys == "spgk") {
        appcall.videos();
      } else if (n.task_keys == "tdhx") {
        appcall.navigator({
          title: "唤醒徒弟",
          url: this.$h5url + pagers[$this.currVer].invitepupil+"?wake=1"
        });
      } else if (n.task_keys == "activity_88888") {
        appcall.navigator({
          title: "新年小目标",
    ...
    async openBox() {
      if (this.detail.is_kbbx == 0) {
        ...
        let rs = await ajax(
          "post",
          this.$apiurl + "/tasks/task_to_open_kbbx",
          comm,
          params
        );
        if (rs && rs.code === 1001) {
...
.taskCenter {
  .taskCenter_top {
    width: 100%;
    height: 3.96rem;
    background-image: url("../../../assets/images/activities/bg.png");
    ...
    .signInBtn {
      ...
      text-align: center;
      border: none;
      background: url("../../../assets/images/activities/qiandao_btn.png")
      ...
      margin-left: -1.6rem;
      &.gray {
        background-image: url("../../../assets/images/activities/qiandao_btn_gray.png");
        font-size: 0.24rem;
      }
      &:active {
        opacity: 0.9;
    ...
    .tips {
      ...
      top: 3.05rem;
      left: 0;
      background: url("../../../assets/images/activities/qiandao_tip.png")
        no-repeat center center;
      background-size: 100%;
    }
  }
      ...
      li {
        ...
        .circle {
          .coin {
            ...
            width: 0.5rem;
            height: 0.5rem;
            background: url("../../../assets/images/activities/coin_gray.png")
              no-repeat center center;
            background-size: 100% 100%;
            margin: 0 auto;
            font-size: 0.18rem;
          ...
          &.gray {
            .coin {
              background-image: url("../../../assets/images/activities/coin_gold.png");
            }
          }
        }
        .day {
  ...
  .taskCenter_treasureBox {
    ...
    .box {
      .bg {
        ...
        background-image: url("../../../assets/images/activities/bx_bg.png");
        background-size: 100%;
        background-repeat: no-repeat;
        position: relative;
        &.gray {
          background-image: url("../../../assets/images/activities/bx2_bg.png");
        }
        .icon {
          width: 1rem;
          height: 0.75rem;
          ...
          top: 0.08rem;
          left: 0.4rem;
          background: url("../../../assets/images/activities/bx.png") no-repeat
            center top;
          background-size: 100%;
          animation: bxshake 2s infinite;
          &.gray {
            background-image: url("../../../assets/images/activities/bx2.png");
            animation: none;
          }
        }
        .txt {
    ...
    .task {
      ...
      .title {
        ...
        .icoNew {
          ...
          width: 0.4rem;
          height: 0.4rem;
          background: url(../../../assets/images/ico_task_new.png) no-repeat
            center center;
          background-size: 100%;
          margin-left: 0.1rem;
        }
      ...
      .taskTitle {
        ...
        .title {
          ...
          i.tip {
            ...
            &.money {
              width: 1.62rem;
              background: url(../../../assets/images/activities/task_ico_money.png)
                no-repeat center center;
              background-size: 100%;
            }
            &.hot {
              width: 0.82rem;
              background: url(../../../assets/images/activities/task_ico_hot.png)
                no-repeat center center;
              background-size: 100%;
            }
            &.new {
              width: 0.82rem;
              background: url(../../../assets/images/activities/task_ico_new.png)
                no-repeat center center;
              background-size: 100%;
            }
          }
          ...
          .tit {
            ...
            &.complete {
              ...
              i.tip {
                ...
                height: 0.39rem;
                display: block;
                background: url(../../../assets/images/ico_task_complete.png)
                  no-repeat center center;
                background-size: 100%;
              }
            }
  ...
  .modal {
    ...
    .treasureBoxModal {
      ...
      &:before {
        ...
        height: 0.95rem;
        display: block;
        background: url(../../../assets/images/pop_sbbx_top.png) no-repeat
          center top;
      ...
      .box {
        height: 3.98rem;
        margin: 0 auto;
        background: url("../../../assets/images/activities/pop_box.png")
          no-repeat center center;
        background-size: auto 100%;
        position: relative;
        margin-top: -0.3rem;
    ...
    .signModal {
      ...
      &:before {
        ...
        height: 1.35rem;
        width: 100%;
        background: url("../../../assets/images/activities/succ_bg.png")
          no-repeat center center;
        background-size: auto 100%;
        top: -0.9rem;
        left: 0;
