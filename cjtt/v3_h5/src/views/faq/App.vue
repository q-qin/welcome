  ...
  <div>
    ...
    <div class="faq" v-show="!loading">
        <header @click="faqVideo" v-if="!iospedding">
          <img src="@/assets/images/faq/faq_herf.png">
        </header>
      ...
      <div class="faq_officialService" @click="Alert" v-show="OSshow">
        <img src="@/assets/images/faq/gfkf.png">
      </div>
    </div>
  </div>
</template>
...
export default {
    ...
    return {
      ...
      faq_invite: [
        ...
        },
        {
          ...
          answer:
            '如图：<br><img src="' +
            require("@/assets/images/faq/faq_coin.png") +
            '" width="100%" />',
          show: false,
          iosshow: true
        },
  ...
  methods: {
      ...
      if (rs && rs.code === 1001 && rs.data) {
        ...
        this.$confirm(
          '<div style="background:url(' +
            require("@/assets/images/faq/wxchop.png") +
    ...
    faqVideo() {
      location.href=this.$v3url + "/faqVideo/index.html";
    },
    change(index) {
