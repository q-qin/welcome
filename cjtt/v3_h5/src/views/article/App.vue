  ...
  <div>
    ...
    <div class="articleDetailAd" v-show="!loading">
      <div class="content">
          ...
          <div class="share" v-show="showShare">
            <div class="shareBox clear">
              <div class="share_item dianzan left" @click="dianzan" :class="{'active':likeStatus}">
                <img src="@/assets/images/article/zanok.png" v-if="likeStatus">
                <img src="@/assets/images/article/zanno.png" v-else>{{detail.likenum}}
              </div>
              <div class="share_item weixin left" @click="wxshare">
                <div class="shareYindao" v-show="isShareYindao&&isHot">分享+50金币</div>
                <img src="@/assets/images/article/wx2.png">微信
              </div>
              <div class="share_item pyq right" @click="pyqshare">
                <img src="@/assets/images/article/pyq.png">朋友圈
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- <div class="bigad" id="PAGE_BB_1"></div> -->
      </div>
      <div class="article_swiper">
          <!-- 第三方广告位 -->
         <div id="bd_001" class="baidu" v-if="thirdArr.length!=0">
        </div>
...
export default {
  ...
  mounted() {
    this.id = this.$utils.getUrlQuery('id');
    this.getdetail();
    this.adType();
    ...
    thirdAd(data) {
      data.forEach(item => {
        switch (item.ad_source) {
          case "baidu":
            setTimeout(()=>{
              BAIDU_CLB_fillSlotAsync(item.slot_id, "bd_001");
            },1000)
            break;
          case "xunfei":
            break;
          ...
          .share_item {
            ...
            .shareYindao{
              ...
              &::after{
                ...
                width: .3rem;
                height: .17rem;
                .background('article/popTriangle.png');
    ...
    .con {
      ...
      .more {
        ...
        i {
          ...
          width: 0.2rem;
          height: 0.12rem;
          .background("article/downMore.png");
          vertical-align: top;
        }
      }
    }
