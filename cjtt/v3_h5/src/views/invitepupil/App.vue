  ...
  <div>
    ...
    <div class="invitepupil" v-show="!loading">
      ...
      <section>
        ...
        <div class="baiducontainer" v-if="thirdArr.length!=0">
             <div id="hancr_001" class="baidu">
        </div>
        </div>
        <template v-if="tab==1">
        ...
        <ul class="clear">
          <li class="left weixin">
            <div class="icon" @click="shareweixin('微信')">
              <img src="@/assets/images/NewInvitepupil/wx.png">
            </div>
          ...
          <li class="left pyq">
            <div class="icon" @click="sharepyq('朋友圈')">
              <img src="@/assets/images/NewInvitepupil/pyq.png">
            </div>
      ...
      <div class="copyCode" v-show="copyCodeshow" @touchmove.prevent>
        <div class="bagrbg">
          <div class="top">
            <div class="head">
              <div class="yes left">
                <img src="@/assets/images/NewInvitepupil/v120_yes.png">
              </div>
              <div class="code left">
          ...
          <div class="list">
            <div class="title clear">
              <div class="cricle left">
                <img src="@/assets/images/NewInvitepupil/radius_one.png">
              </div>
              <div class="text left">邀请好友下载"超级头条"并登录</div>
            </div>
            <div class="share">
              <img src="@/assets/images/NewInvitepupil/share_one.png">
            </div>
          </div>
          <div class="center">
            <div class="title clear">
              <div class="cricle left">
                <img src="@/assets/images/NewInvitepupil/radius_two.png">
              </div>
              <div class="text left">打开"任务中心"页面</div>
            </div>
            <div class="share">
              <img src="@/assets/images/NewInvitepupil/share_two.png">
            </div>
          </div>
          <div class="listbottom">
            <div class="title clear">
              <div class="cricle left">
                <img src="@/assets/images/NewInvitepupil/radius_three.png">
              </div>
              <div class="text left">找到"输入邀请码"输入</div>
            </div>
            <div class="share">
              <img src="@/assets/images/NewInvitepupil/share_three.png">
            </div>
          </div>
      ...
      <div class="v-modal" v-show="mdmModalShow" @touchmove.prevent>
        <div class="mdmModal">
          <img class="mdmBg" src="@/assets/images/NewInvitepupil/mdmBg.png">
          <div class="QRcode">
...
export default {
  ...
  async created() {
    ...
    if (this.iospedding) {
      window.location.replace(this.$v3url + "/main/user.html#/invitepupilOld");
    }
    this.$Progress.start();
  ...
  methods: {
    ...
    togglebtns(position) {
      if (!!position) {
        _hmt.push(["_trackEvent", "invitepupil", "click", position]);
      }
...
.invitepupil {
    ...
    .tapStyle {
      ...
      ul {
        ...
        .criclePosition::before {
          ...
          .background("NewInvitepupil/zhuanqian_v120.png"); // background-repeat: no-repeat;
          top: 0rem;
          right: 0.29rem;
          width: 0.96rem;
          height: 0.96rem;
    ...
    .tabContiner {
      ...
      .rule {
        ...
        .ruleTips {
          ...
          i {
            .wh(0.12rem, 0.2rem);
            .background("NewInvitepupil/ico_next_small.png");
            display: inline-block;
            margin-left: 0.14rem;
          }
        }
  ...
  .v-modal {
    ...
    .winningModal {
      position: absolute;
      .background("NewInvitepupil/winning.png");
    ...
    .rulesModal {
      ...
      .tipsBox {
        ...
        width: 1.83rem;
        height: 0.81rem;
        .background("NewInvitepupil/rulesTips.png");
        background-size: 100% 100%;
        text-align: center;
        font-size: 0.34rem;
        color: #ffffff;
  ...
  .lanternFestival {
    ...
    .rolebg {
      ...
      .tt2 {
        width: 3.86rem;
        margin: 0 auto;
        .background("NewInvitepupil/pop_td_jiangli.png");
        color: #fff;
        text-align: center;
        line-height: 0.5rem;
        font-size: 0.32rem;
      ...
      .txt2 {
        .ico {
          width: 1.53rem;
          height: 1.87rem;
          .background("NewInvitepupil/pop_td_cash.png");
