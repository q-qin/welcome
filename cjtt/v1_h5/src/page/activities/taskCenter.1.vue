...
.taskCenter {
  .taskCenter_top {
    ...
    .signInBtn {
      ...
      text-align: center;
      border: none;
      background: url("../../images/activities/qiandao_btn.png") no-repeat
        center center;
      background-size: 100%;
      color: #fff;
      font-size: 0.4rem;
    ...
    .tips {
      ...
      top: 3.05rem;
      left: 0;
      background: url("../../images/activities/qiandao_tip.png") no-repeat
        center center;
      background-size: 100%;
    }
  }
      ...
      li {
        ...
        .circle {
          .coin {
            ...
            width: 0.5rem;
            height: 0.5rem;
            background: url("../../images/activities/coin_gray.png") no-repeat
              center center;
            background-size: 100% 100%;
            margin: 0 auto;
            font-size: 0.18rem;
      ...
      .taskTitle {
        ...
        .title {
          ...
          i.tip {
            ...
            &.money {
              width: 1.62rem;
              background: url(../../images/activities/task_ico_money.png)
                no-repeat center center;
              background-size: 100%;
            }
            &.hot {
              width: 0.82rem;
              background: url(../../images/activities/task_ico_hot.png)
                no-repeat center center;
              background-size: 100%;
            }
            &.new {
              width: 0.82rem;
              background: url(../../images/activities/task_ico_new.png)
                no-repeat center center;
              background-size: 100%;
            }
          }
          ...
          .tit {
            ...
            &.complete {
              ...
              i.tip {
                ...
                height: 0.39rem;
                display: block;
                background: url(../../images/ico_task_complete.png) no-repeat
                  center center;
                background-size: 100%;
              }
            }
  ...
  .modal {
    ...
    .treasureBoxModal {
      ...
      .box {
        height: 3.98rem;
        margin: 0 auto;
        background: url("../../images/activities/pop_box.png") no-repeat center
          center;
        background-size: auto 100%;
        position: relative;
        margin-top: -0.3rem;
    ...
    .signModal {
      ...
      &:before {
        ...
        height: 1.35rem;
        width: 100%;
        background: url("../../images/activities/succ_bg.png") no-repeat center
          center;
        background-size: auto 100%;
        top: -0.9rem;
        left: 0;
