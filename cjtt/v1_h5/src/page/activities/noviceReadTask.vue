...
<style lang="less" scoped>
  ...
  .noviceReadTask {
    ...
    .noviceReadTask_top {
      ...
      .thumbtack{
        background: url(../../images/activities/newhead_ld.png) no-repeat center center;
        background-size: 100%;
        width: .18rem;
        height: .66rem;
        position: absolute;
    ...
    .noviceReadTask_content {
      ...
      .finished {
        background: url(../../images/activities/nhr_check.png) no-repeat center center;
        background-size: 100%;
      }
      .unfinished {
        background: url(../../images/activities/nhr_fork.png) no-repeat center center;
        background-size: 100%;
      }
    }
    .noviceReadTask_bottom {
      ...
      .state {
        ...
        .task {
          ...
          width: auto;
          .graduate {
            background: url(../../images/activities/nhr_gra.png) no-repeat center center;
            background-size: 100%;
            width: .4rem;
            height: .4rem;
          }
