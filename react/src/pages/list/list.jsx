  ...
  render() {
    return (
      <main className="common-con-top">
        <PublicHeader title='资讯列表' list />
        <section className="record-nav-con">
          <nav className="record-nav">
            <NavLink to={`${this.props.match.path}/passed`} className="nav-link">精华</NavLink>
            <NavLink to={`${this.props.match.path}/audited`} className="nav-link">分享</NavLink>
            <NavLink to={`${this.props.match.path}/failed`} className="nav-link">打假</NavLink>
          </nav>
