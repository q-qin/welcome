 ...
 * 获取资讯数量
 */
export const getNewsCount = data => fetch('/news/count',data);
/**
 * 获取资讯列表
 */
export const getNewsList = data => fetch('/news/list',data);
/**
 * 新增资讯
 */
export const addNews = data =>fetch('/news/add',data,'POST');
/**
 * 修改资讯
 */
export const editNews = data =>fetch('/news/edit',data,'POST');
/**
 * 删除资讯
 */
export const delNews = data =>fetch('/news/delNews',data,'POST');
